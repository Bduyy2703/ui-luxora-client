...
const AdminReviewList = () => {
  ...
  const fetchNotifications = useCallback(async () => {
    try {
      const response = await getNotificationsByTypes(notificationPage, notificationLimit);
                      ...
                      >
                        ...
                        <div className={styles.infoGrid}>
                          <div className={styles.infoItem}>
                            ...
                            <p>{currentReview.user?.email || "N/A"}</p>
                          </div>
                          <div className={styles.infoItem}>
                      ...
                      >
                        ...
                        {currentReview.reply ? (
                          <p className={styles.replyContent}>
                            <strong>Đã trả lời:</strong> {currentReview.reply}
                          </p>
                        ) : (
                          <>
                            <TextArea
